...
class Assets extends BaseController {
	...
	public function assets_list() {
		...
		if($user_info['user_type'] == 'staff'){
			$assets = $AssetsModel->where('company_id',$user_info['company_id'])->orderBy('assets_id', 'ASC')->findAll();
		} else {
		...
		$data = array();
          ...
          foreach($assets as $r) {						
				...
				if(in_array('asset4',staff_role_resource()) || $user_info['user_type'] == 'company' || $user_info['user_type'] == 'staff') { //delete
